...
const seriesSymbols = [
	// { src: require('../img/symbols/AARMS.png'), name: 'Min Min' },
  ...
  { src: require('../img/symbols/Metroid.png'), name: 'Samus' },
	...
	// { src: require('../img/symbols/Minecraft.png'), name: 'Steve' },
  ...
  { src: require('../img/symbols/Pokemon.png'), name: 'Mewtwo' },  
	...
	{ src: require('../img/symbols/SSB.png'), name: 'Mii Brawler' },
	{ src: require('../img/symbols/SSB.png'), name: 'Mii Gunner' },
	{ src: require('../img/symbols/SSB.png'), name: 'Mii Swordfighter' },
